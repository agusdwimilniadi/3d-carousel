...
function changeItem() {
  let description = $("[class*='dg-center'] > div > data > div > p").text();
  let buttonDescription = $(
    "[class*='dg-center'] > div > data > div > button"
  ).text();
  $("#description > div > p").text(`${description}`);
  $("#description > div > div> button").text(`${buttonDescription}`);
}
!(function (e, n, t) {
  function r(e, n) {
    return typeof e === n;
...
(function ($) {
  ...
  $.carrousel.prototype = {
    _init: function (options) {
      ...
      $("#lightButtons").change(function () {
        var toIndex = parseInt($("#lightButtons").find(":selected")[0].value);
        var toMove = toIndex - _self.indexB;
        switch (toMove) {
          case 0:
            break;
    ...
    _showButton: function () {
      ...
      $("#lightButtons").val(`${_self.indexB}`).change();
    },
    ...
    _setItems: function () {
      ...
      // this.$items.find("div").css("display", "none");
    ...
    _getCoordinates: function (position) {
      ...
      if (this.support3d) {
        // for (let i = 1; i <= $("*[id*=testing-class]").length; i++) {
        //   if (
        //     $(`*[id*=testing-class]:nth-child(${i})`).hasClass("dg-center") ===
        //     true
        //   ) {
        //     let variableElements =
        //       parseInt(
        //         $(`*[id*=testing-class]:nth-child(${i})`).attr("data-custom")
        //       ) + 1;
        //     if (variableElements === $("*[id*=testing-class]").length + 1) {
        //       console.log("masuk if satu ");
        //       if (
        //         $(
        //           `*[id*=testing-class]:nth-child(${variableElements})`
        //         ).hasClass("dg-center") === true
        //       ) {
        //         console.log("masuk if dua");

        //         let varReset = 1;
        //         $(`*[id*=testing-class]:nth-child(${varReset}) > div`)
        //           .addClass("show-buttons")
        //           .removeClass("hide-buttons");
        //         $(
        //           `*[id*=testing-class]:nth-child(${
        //             variableElements + 1
        //           }) > div`
        //         )
        ...
        //       } else {
        //         let varReset = 1;
        //         variableElements = variableElements - 2;
        //         console.log("masuk else dua");
        ...
        //       }
        //     } else {
        //       console.log("masuk else satu ", variableElements);
        //       if (
        //         $(
        //           `*[id*=testing-class]:nth-child(${variableElements})`
        //         ).hasClass("dg-center") === true
        //       ) {
        //       }
        //       $(`*[id*=testing-class]:nth-child(${variableElements}) > div`)
        //         .addClass("show-buttons")
        //         .removeClass("hide-buttons");
        //       $(`*[id*=testing-class]:nth-child(${variableElements + 1}) > div`)
        //         .addClass("hide-buttons")
        //         .removeClass("show-buttons");
        //       $(`*[id*=testing-class]:nth-child(${variableElements - 1}) > div`)
        //         .addClass("hide-buttons")
        ...
        // else {
        //     let nilaiBaru = i - 2;
        //     $(`*[id*=testing-class]:nth-child(${nilaiBaru}) > div`)
        //       .addClass("show-buttons")
        //       .removeClass("hide-buttons");
        //     $(`*[id*=testing-class]:nth-child(${nilaiBaru + 1}) > div`)
        //       .addClass("hide-buttons")
        //       .removeClass("show-buttons");
        //     $(`*[id*=testing-class]:nth-child(${nilaiBaru - 1}) > div`)
        //       .addClass("hide-buttons")
        ...
        // console.log("======================");
        // $(`*[id*=testing-class]:nth-child(${1}) > div`)
        //   .addClass("show-buttons")
        //   .removeClass("hide-buttons");
        // for (let i = 0; i < $("*[id*=testing-class]").length; i++) {
        //   console.log("panjang ", $("*[id*=testing-class]").length);
        //   if (
        //     $(`*[id*=testing-class]:nth-child(${i + 1})`).hasClass(
        //       "dg-center"
        //     ) === true
        //   ) {
        //     if (i + 1 === 1) {
        //       if (position === "left" || position === "right") {
        //         $(`*[id*=testing-class]:nth-child(${i + 1}) > div`)
        //           .addClass("hide-buttons")
        //           .removeClass("show-buttons");
        //         console.log("Hapus 1 masuk if", i + 1);
        //       } else {
        //         $(`*[id*=testing-class]:nth-child(${i + 1}) > div`)
        //           .addClass("hide-buttons")
        //           .removeClass("show-buttons");
        //         console.log("Hapus 1 masuk if, else", i + 1);
        //       }
        //     } else {
        //       $(`*[id*=testing-class]:nth-child(${i + 1}) > div`)
        //         .addClass("hide-buttons")
        //         .removeClass("show-buttons");
        //       console.log("Hapus 1 masuk else", i + 1);
        //     }

        //     if (i + 1 + 2 > $("*[id*=testing-class]").length) {
        //       $(`*[id*=testing-class]:nth-child(${i + 1}) > div`)
        //         .addClass("hide-buttons")
        //         .removeClass("show-buttons");
        //       console.log("hapus 2", i + 1);
        //     } else {
        //       $(`*[id*=testing-class]:nth-child(${i + 1 + 2}) > div`)
        //         .addClass("hide-buttons")
        //         .removeClass("show-buttons");
        //       console.log("hapus 2 masuk else", i + 1 + 2);
        //     }
        //   } else if (
        //     $(`*[id*=testing-class]:nth-child(${i + 1})`).hasClass(
        //       "dg-center"
        ...
        //     $(`*[id*=testing-class]:nth-child(${i + 1}) > div`).addClass(
        //       "hide-buttons"
        //     );
        //     console.log("postion><><><> ", position, i + 1);
        //   } else if ((position === "right") === true) {
        //     $(`*[id*=testing-class]:nth-child(${i + 1}) > div`).addClass(
        //       "hide-buttons"
        //     );
        //   } else {
        //     $(`*[id*=testing-class]:nth-child(${i + 1}) > div`).removeClass(
        //       "hide-buttons"
        //     );
        //   }
        // }
        switch (position) {
          ...
          case "left":
            return {
              "-webkit-transform":
                "translateX(-" +
                (this.CSSX + variableX) +
                "px) translateZ(-500px) rotateY(15deg)",
              "-moz-transform":
                "translateX(-" +
                (this.CSSX + variableX) +
                "px) translateZ(-500px) rotateY(15deg)",
          ...
          case "center":
            // $("div .penanda").addClass("description");
            // $("div .penanda > div").removeClass("description");
            return {
              "-webkit-transform":
    ...
    _navigate: function (dir, speedClass) {
      ...
      $(function () {
        function testClick() {
          let description = $(
            "[class*='dg-center'] > div > data > div > p"
          ).text();
          let buttonDescription = $(
            "[class*='dg-center'] > div > data > div > button"
          ).text();
...
// $("*[id*=testing-class]:nth-child(6)").hasClass("dg-center"); // false
function testClick() {
  $("a").attr("href", "#");
}
